...
function(DCG_create_cmake_file projectName isTestProject)
  ...
  foreach(fileId IN ITEMS $ENV{DCG_PROJECT_${projectName}_FILES})
    set(fileType ".c")
    set(interfaceFileType ".h")
    if("$ENV{${fileId}_TYPE}" STREQUAL "DCG_CPP")
      set(fileType ".cpp")
    elseif("$ENV{${fileId}_TYPE}" STREQUAL "DCG_RESOURCE")
      set(fileType "")
      set(interfaceFileType "")
    endif()

    if("$ENV{${fileId}_HAS_INTERFACE}")
      list(APPEND projectInterfaceFiles "\${CMAKE_CURRENT_SOURCE_DIR}/include/$ENV{${fileId}_PATH}${interfaceFileType}")
    endif()
...
function(DCG_replace_strings)
  ...
  foreach(projectName IN ITEMS $ENV{DCG_SOLUTION_PROJECTS})
    ...
    elseif("$ENV{${fileId}_TYPE}" STREQUAL "DCG_RESOURCE")
      ...
      if("$ENV{${fileId}_HAS_INTERFACE}")
        list(APPEND files "projects/${projectName}/include/$ENV{${fileId}_PATH}${interfaceFileType}")
      endif()
