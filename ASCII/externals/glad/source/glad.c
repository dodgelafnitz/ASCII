/*
    ...
    OpenGL loader generated by glad 0.1.35 on Thu May 19 17:05:37 2022.
...
static GLADpostcallcallback glad_postGlCallCallback = NULL;

void gladSetPostGlCallCallback(GLADpostcallcallback callback) {
	glad_postGlCallCallback = callback;
}

void gladPostGlCall(const void *func, const char *name) {
	if (glad_postGlCallCallback != NULL) {
		glad_postGlCallCallback(func, name);
	}
}
